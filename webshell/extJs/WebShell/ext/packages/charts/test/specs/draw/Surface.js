...
topSuite("Ext.draw.Surface", function () {
    ...
    describe('remove', function () {
        ...
        TODO(Object.setPrototypeOf && jasmine.CLEAR_PROTOTYPE, 'Make it work with prototype clearing').it("if passed an already destroyed sprite, should return it without doing anything", function () {
