...
topSuite("Ext.chart.series.Series",
    ...
    function () {
        ...
        describe('label', function () {
            ...
            TODO(Ext.isSafari7).it('should allow for dynamic updates of the "field" config', function () {
                var layoutDone;
        ...
        describe('coordinate', function () {
            ...
            TODO(Ext.isSafari7).it('should update series range as more related series get coordinated', function () {
